...
with col1:
    ...
    fig1.add_trace(go.Scatter(x=ts_df["DATE"], y=ts_df["USERS"], name="Users", mode="lines", yaxis="y2", line=dict(color="#0ed145", width=2, dash="solid")))
...
with col2:
    ...
    fig2.add_trace(go.Scatter(x=ts_df["DATE"], y=ts_df["AVG_VOLUME_TX"], name="Avg Volume per Txn", mode="lines", yaxis="y2", line=dict(color="#0ed145", width=2, dash="solid")))
